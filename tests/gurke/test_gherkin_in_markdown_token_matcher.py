from gurke.gherkin_line import GherkinLine
...
def test_it_matches_feature_line() -> None:
...
def test_it_matches_feature_line_in_french() -> None:
...
def test_it_matches_bullet_step() -> None:
    tm = GherkinInMarkdownTokenMatcher("en")
...
def test_it_matches_plus_step() -> None:
    tm = GherkinInMarkdownTokenMatcher("en")
    line = GherkinLine("""  +  Given I have 3 cukes""", location.line)
    token = Token(gherkin_line=line, location=location)
    assert tm.match_StepLine(token)
...
def test_it_matches_hyphen_step() -> None:
    tm = GherkinInMarkdownTokenMatcher("en")
    line = GherkinLine("""  -  Given I have 3 cukes""", location.line)
    token = Token(gherkin_line=line, location=location)
    assert tm.match_StepLine(token)
...
def test_it_matches_arbitrary_text_as_other() -> None:
    tm = GherkinInMarkdownTokenMatcher("en")
...
def test_it_matches_a_non_keyword_line_as_other() -> None:
    tm = GherkinInMarkdownTokenMatcher("en")
...
def test_it_matches_a_non_keyword_header_line_as_other() -> None:
    tm = GherkinInMarkdownTokenMatcher("en")
...
def test_it_matches_3_ticks_doctring_separator() -> None:
    tm = GherkinInMarkdownTokenMatcher("en")
...
def test_it_matches_4_ticks_doctring_separator() -> None:
    tm = GherkinInMarkdownTokenMatcher("en")
...
def test_it_matches_table_row_indented_2_spaces() -> None:
    tm = GherkinInMarkdownTokenMatcher("en")
...
def test_it_matches_table_row_indented_5_spaces() -> None:
    tm = GherkinInMarkdownTokenMatcher("en")
    gherkin_line = GherkinLine("""     |foo|bar|""", location.line)
    token = Token(gherkin_line, location)
    assert tm.match_TableRow(token)
...
# TODO a table in a markdown file can start at column 0 but not in a feature file, why?
# def test_it_does_not_match_table_row_indented_1_space() -> None:
#     tm = GherkinInMarkdownTokenMatcher("en")
#     gherkin_line = GherkinLine("""|foo|bar|""", location.line)
#     token = Token(gherkin_line, location)
...
def test_it_does_not_match_table_row_indented_6_space() -> None:
    tm = GherkinInMarkdownTokenMatcher("en")
    gherkin_line = GherkinLine("""      |foo|bar|""", location.line)
    token = Token(gherkin_line, location)
    assert not tm.match_TableRow(token)
...
def test_it_matches_table_separator_row_as_comment() -> None:
    tm = GherkinInMarkdownTokenMatcher("en")
...
def test_it_matches_indented_tags() -> None:
    tm = GherkinInMarkdownTokenMatcher("en")
...
def test_it_matches_unindented_tags() -> None:
    tm = GherkinInMarkdownTokenMatcher("en")
...
def test_it_matches_RuleLine() -> None:
    tm = GherkinInMarkdownTokenMatcher("en")
...
def test_it_matches_ScenarioLine() -> None:
    tm = GherkinInMarkdownTokenMatcher("en")
...
def test_it_matches_ScenarioLine_outline() -> None:
    tm = GherkinInMarkdownTokenMatcher("en")
...
def test_it_matches_backgroundLine() -> None:
    tm = GherkinInMarkdownTokenMatcher("en")
...
def test_it_matches_ExamplesLine() -> None:
    tm = GherkinInMarkdownTokenMatcher("en")
